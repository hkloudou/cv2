...
It carries the prebuilt static libraries for windows/amd64:

- `libs/windows_amd64/` - the Go module `github.com/hkloudou/cv2/libs/windows_amd64`
  (release tags `libs/windows_amd64/vX.Y.Z` point into this branch)
