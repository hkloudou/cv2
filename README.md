...
It carries the prebuilt static libraries for linux/386:

- `libs/linux_386/` - the Go module `github.com/hkloudou/cv2/libs/linux_386`
  (release tags `libs/linux_386/vX.Y.Z` point into this branch)
